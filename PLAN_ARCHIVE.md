...
## Bus Arrivals — design doc (shipped; swept 2026-08-01)

The full pre-implementation design doc for the bus arrivals feature, preserved verbatim below. The feature shipped as designed — TransitAPI target, MonitoredStop table, BusSettings, BusArrivalsBar on the dashboard — and the doc sat at the top of PLAN.md long past its usefulness. Deferred ideas from its §12 live on in the doc, not in Backlog; pull from there if one graduates.
